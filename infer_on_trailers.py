...
FINAL_OUTPUT_JSON = "inference_results.json"
PARTIAL_OUTPUT_JSON = "inference_partial.json"
...
VIDEO_SRC_DIR = "../EmoStimDS/top5trailers"
VIDEO_TMP_DIR = os.path.join(TMPDIR, "top5trailers")
